...
import eu.xenit.alfresco.webscripst.client.ditto.SlingShotDittoClient;
...
public class SlingShotDittoClientIntegrationTest implements SlingShotClientTests {

    private final AlfrescoDataSet dataSet = AlfrescoDataSet.bootstrapAlfresco().build();

    @Override
    public SlingshotClient slingShotClient() {
        return new SlingShotDittoClient(dataSet);
    }
